...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030712] flex items-center justify-center px-3 sm:px-4 md:px-6 pt-16 sm:pt-20 md:pt-20">
      <div className="absolute bottom-0 right-0 w-[300px] sm:w-[400px] md:w-[500px] h-[300px] sm:h-[400px] md:h-[500px] bg-blue-500/5 blur-[80px] sm:blur-[100px] md:blur-[120px] rounded-full pointer-events-none"></div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-6">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            <div className="flex justify-between items-center ml-2 sm:ml-3 md:ml-4 mr-1 sm:mr-2">
              <label className="text-[8px] sm:text-[9px] md:text-[10px] font-black uppercase tracking-[0.15em] md:tracking-[0.2em] text-gray-400">
                Password
              </label>
              <button
                type="button"
                className="text-[7px] sm:text-[8px] md:text-[9px] font-black uppercase text-cyan-400/60 hover:text-cyan-400"
              >
                Forgot?
              </button>
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 sm:py-3 md:py-5 bg-white text-black font-black uppercase tracking-tighter md:tracking-widest text-[8px] sm:text-[9px] md:text-xs rounded-lg sm:rounded-xl md:rounded-2xl hover:bg-cyan-400 transition-all active:scale-95 shadow-xl mt-3 sm:mt-4 md:mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="mt-6 sm:mt-8 md:mt-10 pt-4 sm:pt-6 md:pt-8 border-t border-white/5 text-center">
          <p className="text-gray-500 text-[8px] sm:text-[9px] md:text-xs font-medium">
            ...
            <Link
              to="/register"
              className="text-cyan-400 hover:underline inline-block mt-1 sm:mt-2 font-bold uppercase tracking-tighter md:tracking-widest text-[8px] sm:text-[9px] md:text-[10px]"
            >
              Create an Account
            </Link>
          </p>
